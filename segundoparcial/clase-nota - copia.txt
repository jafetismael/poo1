...
case default => println("Adios...") } } while (opcion != 3)}
...
continuar = readChar() } while (continuar == 's')}
...
def mostrarCatalogoProductos(catalogo: Catalogo) {+  println("Nombre | Precio | Código")
